...
namespace Nuclear.TestSite.Results {
    class ResultKeyExecutionRuntimeLevel_uTests {
        ...
        void TestConstructor() {
            ...
            DDTestKey(key, (null, null, ProcessorArchitecture.None, null));
            ...
            DDTestKey(key, (String.Empty, String.Empty, ProcessorArchitecture.MSIL, String.Empty));
            ...
            DDTestKey(key, ("SomeAssemblyName", "SomeTargetRuntime", ProcessorArchitecture.MSIL, "SomeExecutionRuntime"));
        ...
        void TestIncrementalConstructor() {
            ...
            DDTestKey(key, (String.Empty, null, ProcessorArchitecture.None, null));
            ...
            DDTestKey(key, ("ASDF", String.Empty, ProcessorArchitecture.MSIL, "SomeExecutionRuntime"));

        }

        void DDTestKey(ResultKeyExecutionRuntimeLevel key, (String assembly, String targetRuntime, ProcessorArchitecture architecture, String executionRuntime) expected,
