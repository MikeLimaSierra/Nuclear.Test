...
namespace Nuclear.Test.Extensions {
    internal static class ITestResultsSourceExtensions {
        ...
        public static IEnumerable<ITestResultKey> GetKeys(this ITestResultsSource _this, ITestResultKey match)
            => _this.Keys.Where(key => key.Matches(match));

        public static IEnumerable<ITestResultKey> GetKeys(this ITestResultsSource _this, ITestResultKey match, TestResultKeyPrecisions precision) {
        ...
        public static IEnumerable<ITestMethodResult> GetResults(this ITestResultsSource _this, ITestResultKey match)
