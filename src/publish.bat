...
dotnet publish --self-contained true -r win-x86 -c Release -f netcoreapp2.0 -o ..\publish\Nuclear.Test.Console\Nuclear.Test.Worker\MSIL\NETCore2.0\ Nuclear.Test.Worker\Nuclear.Test.Worker.csproj
dotnet publish --self-contained true -r win-x64 -c Release -f netcoreapp2.0 -o ..\publish\Nuclear.Test.Console\Nuclear.Test.Worker\Amd64\NETCore2.0\ Nuclear.Test.Worker\Nuclear.Test.Worker.csproj
dotnet publish --self-contained true -r win-x86 -c Release -f netcoreapp2.0 -o ..\publish\Nuclear.Test.Console\Nuclear.Test.Worker\X86\NETCore2.0\ Nuclear.Test.Worker\Nuclear.Test.Worker.csproj

dotnet publish --self-contained true -r win-x86 -c Release -f netcoreapp2.1 -o ..\publish\Nuclear.Test.Console\Nuclear.Test.Worker\MSIL\NETCore2.1\ Nuclear.Test.Worker\Nuclear.Test.Worker.csproj
